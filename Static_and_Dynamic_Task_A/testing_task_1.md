...
class CardGame
  ...
  # The function is not properly indented.
  #Highest_card has not set correct the number of arguments, missing a "," between card1 and card2
  # Also in the if statement it should return card1.name, and in the else statement the return value should be card2.name
  # Card class doesn't have Name property therefore should use .suit
...
# variable Total hasn't been correctly created. Missing "= 0"
